...
export default {
  ...
  formatMonthYear: timestamp =>
    moment(timestamp).utcOffset(7).format('MM/YYYY'),
  ...
  formatYear: timestamp => moment(timestamp).utcOffset(7).format('YYYY'),
  formatMonth: timestamp => moment(timestamp).utcOffset(7).format('MM'),
  ...
  formatShortYear: timestamp =>
    moment(timestamp).utcOffset(7).format('DD/MM/YY'),
